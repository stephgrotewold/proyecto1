...
def edit_cant(pid, cantidad1, db):
    if (type(pid) not in [int] or type(cantidad1) not in [int]):
        raise TypeError('ID o Cantidad deben ser enteros')
    for item in db:
        if item['item_id'] == pid:
            item['cantidad'] = cantidad1
            return 1
    return 0
...
#Buscar un ID  y retorna la base de datos
def search_id(id2):
...
#Busca el nombre y retorna el nombre de la base de datos
    ...
    try:
        ...
        if opcion == 1:
            while opcioncompra != 5:
                ...
                try:
                    opcioncompra = int(
                        input('Ingrese la opción que desea realizar \n'))
                except:
                    ...
                    try:
                        ...
                        if (opcion1 == 1):
                            try:
                                ...
                                if (positivo(cantsum) == 1):
                                    #Retorna la base de datos en la que se encuentra
                        ...
                        if (opcion1 == 4):
                            ...
                            try:
                                ...
                                #Imprime la base de datos de la categoria deseada
                                if (categoria == 1):
                                    for x in item_database_alcohol:
                                        print(x)
                                if (categoria == 2):
                        ...
                        if (opcion1 == 5):
                            try:
                                ...
                                if (positivo(quantity) == 1
                                        and positivo(price) == 1):
                                    #Retorna la base de datos en la que se encuentra
